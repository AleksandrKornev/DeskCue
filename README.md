...
Once `v0.2.3` or a newer release is published, install the per-user standalone
build with:
...
The `v0.2.3` release candidate adds glibc Linux x64/arm64 standalone archives
